      ...
      <section className="py-20 px-4 bg-[#FAFDFA] border-y border-gray-100">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h2 className="text-3xl font-extrabold text-gray-900 font-sora">
          ...
          <div className="relative rounded-[3rem] overflow-hidden shadow-2xl border border-gray-100 group">
            <img
              src="/install-image.png"
              alt="Solar panel installation process on Indian rooftop with technician installing panels and wiring setup"
